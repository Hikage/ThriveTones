 ...
 * Music String by a diatonic interval (1 -- unison, 2 -- second, ... 8 -- octave, etc.). 
...
public class DiatonicIntervalPatternTransformer extends PatternTransformer
{
    ...
    {
        super();
        putVariable(INTERVAL, new Integer(1));  // unison
    }
    ...
    {
        note = adjustNote(note, ((Integer)getVariable(INTERVAL)).intValue());
